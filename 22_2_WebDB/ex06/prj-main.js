...
app.get('/book/search', function(request, response){
    search.book_search(request, response);
});
...
app.post('/book/cart_process/:bookId', function(request, response){
    etc.cart_process(request, response);
});
app.post('/purchase_process/:bookId', function(request, response){
    etc.purchase_process(request, response);
});
app.post('/dirpurchase_process/:bookId', function(request, response){
    etc.dirpurchase_process(request, response);
});
app.get('/purchase', function(request, response){
    etc.purchase(request, response);
});
app.post('/cancel_process/:pId', function(request, response){
    etc.cancel_process(request, response);
});
app.get('/book/ebook', function(request, response){
    etc.ebook(request, response);
});
app.get('/book/best', function(request, response){
    etc.best(request, response);
});
app.get('/book/month', function(request, response){
    etc.month(request, response);
});
